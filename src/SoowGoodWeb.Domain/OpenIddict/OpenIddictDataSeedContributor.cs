...
namespace SoowGoodWeb.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _scopeManager.FindByNameAsync("SoowGoodWeb") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "SoowGoodWeb",
                DisplayName = "SoowGoodWeb API",
                Resources =
                {
                    "SoowGoodWeb"
                }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var consoleAndAngularClientRootUrl = configurationSection["SoowGoodWeb_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
        ...
        {
            var swaggerRootUrl = configurationSection["SoowGoodWeb_Swagger:RootUrl"]?.TrimEnd('/');
